...
if not openai_api_key:
    ...
    if prompt := st.chat_input("Ask a question:"):
        ...
        context = (
            f"The following franchises have issues with their SOCs Growth:\n{socs_growth_issues}"
        )
